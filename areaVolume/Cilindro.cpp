...
Cilindro::Cilindro( ): Circulo(  ) // construtor da classe, como herda de Circulo, então o construtor de Circulo recebe os valores como parametro aqui
{
	this->altura = 0;
}
...
:Circulo( x, y, raio ) //os parametros x, y e raio
{
	if( altura > 0 ) // a altura deverá ser maior que 0 pra que seja um cilindro, caso contrário será só mais um círculo!
		this->altura = altura; // o atributo (this) altura (declarada no .h // go check! //) recebe o valor da altura (parâmetro) de forma
